			...
			<tbody>
				<c:forEach items="${profeedback}" var="pro">
					<tr>
						...
						<td><a
							href="${ctx}/editFeedback.jsp?
							FEEDBACK_ID=${pro.Fb_Id}&FEEDBACK_CONTENT=${pro.Fb_Content}
							&FEEDBACK_CONTACT=${pro.Fb_Contact}&FEEDBACK_TIME=${pro.Fb_Time}
							&FEEDBACK_STATUS=${pro.Fb_Status}">编辑</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
