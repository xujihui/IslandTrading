...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<table class="imgtable">
			<thead>
				<tr>
					<th width="100px;">反馈ID</th>
					<th width="100px;">反馈内容</th>
					<th width="100px;">反馈联系方式</th>
			...
			<tbody>
				<c:forEach items="${profeedback}" var="pro">
					<tr>
						<td>${profeedback.Fb_Id}</td>
						<td>${profeedback.Fb_Content}</td>
						<td>${profeedback.Fb_Contact}</td>
						<td>${profeedback.Fb_Time}</td>
						<td>${profeedback.Fb_Status}</td>
						<td><a href="${ctx}/feedback/deleteByID/${pro.Fb_Id}">删除</a></td>
						<td><a
							href="${ctx}/editFeedback.jsp?FEEDBACK_ID=${profeedback.Fb_Id}
							&FEEDBACK_CONTENT=${profeedback.Fb_Content}&FEEDBACK_CONTACT=${profeedback.Fb_Contact}&FEEDBACK_TIME=${profeedback.Fb_Time}
							&FEEDBACK_STATUS=${profeedback.Fb_Status}">编辑</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
