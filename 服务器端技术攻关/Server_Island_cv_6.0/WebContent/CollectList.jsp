...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<table class="imgtable">
			<thead>
				<tr>
					<th width="100px;">收藏ID</th>
					<th width="100px;">收藏状态</th>
					<th width="100px;">收藏时间</th>
					<th width="100px;" colspan="2">操作</th>
				</tr>
			</thead>
			<tbody>
				<c:forEach items="${procollect}" var="pro">
					<tr>
						<td>${pro.Collect_Id}</td>
						<td>${pro.Collect_Status}</td>
						<td>${pro.Collect_Time}</td>
						<td><a href="${ctx}/collect/deleteByID/${pro.Collect_Id}">删除</a></td>
						<td><a
							href="${ctx}/editCollect.jsp?COLLECT_ID=${pro.Collect_Id}
							&COLLECT_STATUS=${pro.Collect_Status}&COLLECT_TIME=${pro.Collect_Time}">编辑</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
