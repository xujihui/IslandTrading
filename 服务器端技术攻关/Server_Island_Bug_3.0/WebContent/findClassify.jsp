...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<form action="${ctx}/classify/findByID" method="post">
			分类ID：<input type="text" name="Classify_Id" size="40" id="Classify_Id" /> <input
				type="submit" style="background: #DDDDFF" value="查找"><a
				href="${ctx}/classify/list" target="rightFrame"><u>返回分类列表页</u></a>
		</form>
