		...
		<table class="imgtable">
			<thead>
				<tr>
					...
					<th width="80px;">用户头像</th>
					<th width="80px;">用户权限</th>
					<th width="80px;">用户TKID</th>
					<th width="80px;">用户电话</th>
					<th width="80px;">环信账号</th>
					<th width="80px;">环信密码</th>
				...
				<c:forEach items="${prouser}" var="pro">
					<tr>
						...
						<td><a
							...
							&USER_IMAGE=${pro.User_Image}&USER_POWER=${pro.User_Power}
							&USER_TAKINGID=${pro.User_TakingId}&USER_TEL=${pro.User_Tel}
							&HX_USERNAME=${pro.Hx_Username}&HX_PASSWORD=${pro.Hx_Password}
							">编辑</a></td>
					</tr>
				</c:forEach>
			</tbody>
