		...
		<form action="${ctx}/activity/save" method="post">
			<table align="center" class="imgtable">
				<tr height="80">
					...
					<td><input type="text" name="ACTIVITY_ID" size="40" id="ACTIVITY_ID"
						height="60" /></td>
					<td>*${idMsg}</td>
				</tr>
				<tr height="80">
					<td>活动名称：</td>
					<td><input type="text" name="ACTIVITY_NAME" size="40" id="ACTIVITY_NAME" /></td>
					<td>*${nameMsg}</td>
				</tr>
				<tr height="80">
					<td>活动内容：</td>
					<td><input type="text" name="ACTIVITY_CONTENT" size="40" id="ACTIVITY_CONTENT" /></td>
					<td>*${contentMsg}</td>
				</tr>
				<tr height="80">
					<td>活动组织单位：</td>
					<td><input type="text" name="ACTIVITY_ORGANIZER" size="40" id="ACTIVITY_ORGANIZER" /></td>
					<td>*${organizerMsg}</td>
				</tr>
				<tr height="80">
					<td>活动发布时间：</td>
					<td><input type="text" name="ACTIVITY_TIME" size="40" id="ACTIVITY_TIME" /></td>
					<td>*${timeMsg}</td>
				</tr>
				<tr height="80">
					<td>活动发布位置：</td>
					<td><input type="text" name="ACTIVITY_SITE" size="40" id="ACTIVITY_SITE" /></td>
					<td>*${siteMsg}</td>
				</tr>
				<tr height="80">
