...
<%
	...
	String ACTIVITY_CONTENT = new String(request.getParameter("ACTIVITY_CONTENT").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("ACTIVITY_CONTENT",ACTIVITY_CONTENT);
	
	String ACTIVITY_ORGANIZER = new String(request.getParameter("ACTIVITY_ORGANIZER").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("ACTIVITY_ORGANIZER",ACTIVITY_ORGANIZER);
	
	String ACTIVITY_TIME = request.getParameter("ACTIVITY_TIME");
	request.setAttribute("ACTIVITY_TIME", ACTIVITY_TIME);
	
	String ACTIVITY_IMG = new String(request.getParameter("ACTIVITY_IMG").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("ACTIVITY_IMG",ACTIVITY_IMG);
	
	String ACTIVITY_SITE = new String(request.getParameter("ACTIVITY_SITE").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("ACTIVITY_SITE",ACTIVITY_SITE);
	
	String ACTIVITY_NAME = new String(request.getParameter("ACTIVITY_NAME").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("ACTIVITY_NAME",ACTIVITY_NAME);
%>
			...
			<table align="center">
				...
				<tr height="80">
					...
					<td><input type="text" name="ACTIVITY_IMG" size="40"
						value="${ACTIVITY_IMG}" id="ACTIVITY_IMG" /></td>
					<td>${imgMsg}</td>
				</tr>
