...
<%
	...
	String CLASSIFY_IMAGE = new String(request.getParameter("CLASSIFY_IMAGE").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("CLASSIFY_IMAGE",CLASSIFY_IMAGE);
