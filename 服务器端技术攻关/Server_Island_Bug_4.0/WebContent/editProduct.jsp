...
<%
	...
	String PRODUCT_IMAGE = new String(request.getParameter("PRODUCT_IMAGE").getBytes("ISO-8859-1"),"utf-8");
	request.getSession().setAttribute("PRODUCT_IMAGE",PRODUCT_IMAGE);
