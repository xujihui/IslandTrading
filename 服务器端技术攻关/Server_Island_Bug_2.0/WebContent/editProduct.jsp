...
<%
	...
	request.setAttribute("PRODUCT_DESCRIBE", PRODUCT_DESCRIBE);
	...
	String PRODUCT_SITE = request.getParameter("PRODUCT_SITE");
	request.setAttribute("PRODUCT_SITE", PRODUCT_SITE);
	...
	String PRODUCT_MESSAGE = request.getParameter("PRODUCT_MESSAGE");
	request.setAttribute("PRODUCT_MESSAGE", PRODUCT_MESSAGE);
%>
