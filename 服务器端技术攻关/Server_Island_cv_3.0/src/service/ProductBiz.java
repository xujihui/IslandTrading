...
public class ProductBiz {
	...
	public boolean save(String pId,String pName,float pPrice,String pDescribe
			,String pImage,String pTime,String pSite,String pView,
			String pPositive,String pStatus,String pMessage ){
		Record pro = new Record()
				.set("Product_Id", pId).set("Product_Name", pName)
				.set("Product_Price", pPrice).set("Product_Describe",pDescribe)
				.set("Product_Image",pImage).set("Product_Time",pTime)
				.set("Product_Site", pSite).set("Product_View",pView)
				.set("Product_Positive", pPositive).set("Product_Status",pStatus)
				.set("Product_Message",pMessage);
	...
	public int update(String pId,String pName,String pPrice,String pDescribe
		...
		"Product_Describe='"+pDescribe+"',"+
	    "Product_Image='"+pImage+"',"+
		"Product_Time='"+pTime+"',"+
		"Product_Site='"+pSite +"'"+
		"Product_View='"+pView+"',"+
	    "Product_Positive='"+pPositive+"',"+
		"Product_Status='"+pStatus+"',"+
		"Product_Message='"+pMessage +"'"+
