			...
			<tbody>
				<c:forEach items="${prolist}" var="pro">
					<tr>
						...
						<td>${pro.time}</td>
						<td>${pro.status}</td>
						<td><a href="${ctx}/feedback/deleteByID/${pro.id}">删除</a></td>
						<td><a
							href="${ctx}/editFeedback.jsp?proID=${pro.id}
							&proUser_id=${pro.user_id}&proContent=${pro.content}&proContact=${pro.contact}
							&proTime=${pro.time}&proStatus=${pro.status}">编辑</a></td>
					</tr>
				</c:forEach>
			</tbody>
		</table>
