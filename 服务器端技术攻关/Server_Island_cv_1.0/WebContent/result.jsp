...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<h1 align="center">${result} <a href="${ctx}/product/list"><u>返回商品列表页</u></a> </h1>
		<h1 align="center">${result} <a href="${ctx}/activity/list"><u>返回活动列表页</u></a> </h1>
		<h1 align="center">${result} <a href="${ctx}/classify/list"><u>返回分类列表页</u></a> </h1>
		<h1 align="center">${result} <a href="${ctx}/feedback/list"><u>返回反馈列表页</u></a> </h1>
		<h1 align="center">${result} <a href="${ctx}/uesr/list"><u>返回用户列表页</u></a> </h1>
		<h1 align="center">${result} <a href="${ctx}/order/list"><u>返回订单列表页</u></a> </h1>
	</div>
</body>
</html>
