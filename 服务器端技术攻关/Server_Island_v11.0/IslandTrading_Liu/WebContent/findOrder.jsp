...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<form action="${ctx}/order/findByID" method="post">
			订单ID：<input type="text" name="Order_Id" size="40" id="Order_Id" /> <input
				type="submit" value="查找" style="background: #DDDDFF"><a
				href="${ctx}/order/list" target="rightFrame"><u>返回订单列表页</u></a>
		</form>
