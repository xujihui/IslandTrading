...
public class DemoConfig extends JFinalConfig {
	...
	public void configConstant(Constants me) {
		...
		me.setBaseUploadPath("E:\\完整示例\\IslandTrading_Liu\\WebContent\\sccImg");	
		me.setBaseDownloadPath("E:\\完整示例\\IslandTrading_Liu\\WebContent\\sccImg");
	...
	public void configPlugin(Plugins me) {
		C3p0Plugin cp = new C3p0Plugin(
				"jdbc:mysql://localhost/mr.liu?useUnicode=true&characterEncoding=UTF-8", "root", "");
		me.add(cp);
