...
<body style="background: #f0f9fd;">
	...
	<div class="center">
		<h1 align="center">${result}
			<a href="${ctx}/classify/list"><u>返回分类列表页</u></a>
		</h1>
		<form action="${ctx}/classify/save" method="post">
			<table align="center" class="imgtable">
				<tr height="80">
					<td width="100">分类ID：</td>
					<td><input type="text" name="CLASSIFY_ID" size="40" id="CLASSIFY_ID"
						height="60" /></td>
					<td>*${idMsg}</td>
				</tr>
				<tr height="80">
					<td>分类名称：</td>
					<td><input type="text" name="CLASSIFY_NAME" size="40" id="CLASSIFY_NAME" /></td>
					<td>*${nameMsg}</td>
				</tr>
				<tr height="80">
					<td>分类图片：</td>
					<td><input type="text" name="CLASSIFY_IMAGE" size="40" id="CLASSIFY_IMAGE" /></td>
					<td>*${imageMsg}</td>
				</tr>
				<tr height="80">
