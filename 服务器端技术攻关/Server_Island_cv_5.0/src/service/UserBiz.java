...
public class UserBiz {
	 ...
	 * 增加用户
	 */
	public boolean save(String pID, String pNickname, String pUsername, String pPassword, String pImage, String pPower,
			String pTakingid, String pTel, String pHx_username, String pHx_password) {
		Record pro = new Record().set("User_Id", pID).set("User_Nickname", pNickname).set("User_Username", pUsername)
	...
	public int update(String pID, String pNickname, String pUsername, String pPassword, String pImage, String pPower,
			String pTakingid, String pTel, String pHx_username, String pHx_password) {
		String sql = "UPDATE islandtrading_username SET" + " User_Id='" + pID + "'," + "User_Nickname='" + pNickname
