...
public class ClassifyBiz {
	...
	public boolean save(String pId, String pName, String pImage) {
		Record pro = new Record().set("Classify_Id", pId).set("Classify_Name", pName).set("Classify_Image", pImage);
	...
	public int update(String pId, String pName, String pImage) {
		String sql = "UPDATE islandtrading_classify SET" + " Classify_Id='" + pId + "Classify_Name='" + pName + "',"
				+ "Classify_Image='" + pImage + " WHERE Classify_Id='" + pId + "'";
