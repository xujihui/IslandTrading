package com.daomaidaomai.chattest;
...
public class ECMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!EMClient.getInstance().isLoggedInBefore()) {
            Intent intent = new Intent(ECMainActivity.this,com.daomaidaomai.chattest.ECLoginActivity.class);
        ...
        mStartChatBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(chatId)) {
                    ...
                    // 跳转到聊天界面，开始聊天
                    Intent intent = new Intent(ECMainActivity.this, com.daomaidaomai.chattest.ECChatActivity.class);
